...
def main():
    # Replace '7097329647:AAFb-HnhTTxzBc65kaPX3Rbt_CcH3f4_jNo's token
    application = Application.builder().token("7202828888:AAHm38HLdtq7ze9mhbcLI9f_67yNlP9pgkg").build()
